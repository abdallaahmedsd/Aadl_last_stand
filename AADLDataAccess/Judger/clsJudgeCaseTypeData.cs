...
namespace AADLDataAccess.Judger
{
    ...
    {
        public static bool GetJudgeCaseTypeInfoByCaseTypeID(int JudgeCaseTypeID, ref string JudgeCaseTypeName, ref int CreatedByAmdinID)
        {
            bool isFound = false;
                    ...
                    using (SqlCommand command = new SqlCommand("SP_GetJudgeCaseTypeInfoByCaseTypeID", connection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            ...
                            if (reader.Read())
                            {
                                ...
                                CreatedByAmdinID = (int)reader["CreatedByAmdinID"];
        ...
        public static bool GetJudgeCaseTypeInfoByCaseTypeName(string JudgeCaseTypeName, ref int JudgeCaseTypeID, ref int CreatedByAmdinID)
        {
            bool isFound = false;
        ...
        public static int AddNewJudgeCaseType(string JudgeCaseTypeName, int CreatedByAmdinID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
                {
                    using (SqlCommand command = new SqlCommand("SP_AddNewJudgeCaseType", connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@JudgeCaseTypeName", JudgeCaseTypeName);
                        command.Parameters.AddWithValue("@CreatedByAmdinID", CreatedByAmdinID);
        ...
        public static bool UpdateJudgeCaseType(int? JudgeCaseTypeID, string JudgeCaseTypeName)
        {
            int rowsAffected = 0;
